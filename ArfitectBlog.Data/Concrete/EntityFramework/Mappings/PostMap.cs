...
namespace ArfitectBlog.Data.Concrete.EntityFramework.Mappings
{
    public class PostMap : IEntityTypeConfiguration<Post>
    {
        public void Configure(EntityTypeBuilder<Post> builder)
        {
            ...
            builder.HasOne<Category>(a => a.Category).WithMany(c => c.Posts).HasForeignKey(a => a.CategoryId);
            builder.HasOne<User>(a => a.User).WithMany(u => u.Posts).HasForeignKey(a => a.UserId);
