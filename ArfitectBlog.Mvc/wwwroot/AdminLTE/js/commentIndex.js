                            ...
                            if (commentResult.Data) {
                                ...
                                $.each(commentResult.Data.Comments.$values,
                                    function (index, comment) {
                                        ...
                                        let newPost = getJsonNetObject(newComment.Post, newComment);
                                        if (newPost !== null) {
                                            postsArray.push(newPost);
                                        }
                                        if (newPost === null) {
                                            newPost = postsArray.find((post) => {
                                                return post.$id === newComment.Post.$ref;
                                            });
                                        }
                        ...
                        success: function (data) {
                            ...
                            if (commentResult.Data) {
                                dataTable.row(tableRow).data([
                                    ...
                                    commentResult.Data.Comment.Post.Title,
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Başarısız İşlem!',
                                    text: `${commentId} beklenmedik bir hata ile karşılaşıldı.`,
                                });
                            }
                        },
                        error: function (err) {
